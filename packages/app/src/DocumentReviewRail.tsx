            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  isSelected
                    ? "border-[#DFDFDC] dark:border-slate-600 bg-white dark:bg-background shadow-[0_20px_48px_rgba(57,47,38,0.14)] dark:shadow-[0_20px_48px_rgba(0,0,0,0.4)]"
                    : "",
          ...
          if (layout.type === "draft") {
            return (
              <div
                ...
                className="-translate-x-2 absolute left-0 right-0 rounded-xl border border-[#DFDFDC] dark:border-slate-600 bg-white dark:bg-background px-4 py-3 shadow-[0_20px_48px_rgba(57,47,38,0.14)] dark:shadow-[0_20px_48px_rgba(0,0,0,0.4)] transition-all duration-200 ease-out will-change-transform"
                style={{ top: layout.railTop }}
              >
          ...
          return (
            <div
              ...
              className={cn(
                "absolute left-0 right-0 rounded-xl border border-transparent bg-transparent shadow-none transition-all duration-200 ease-out will-change-transform",
                isSelected
                  ? "-translate-x-2 border-[#DFDFDC] dark:border-slate-600 bg-white dark:bg-background shadow-[0_20px_48px_rgba(57,47,38,0.14)] dark:shadow-[0_20px_48px_rgba(0,0,0,0.4)]"
                  : "",
